...
class DQNAgent:
    ...
    def make_model(self):
        ...
        # Camada de entrada e primeira camada oculta: 24 neurônios, ativação ReLU.
        model.add(layers.Dense(24, input_dim=self.state_size, activation=activations.relu))
        
        # Segunda camada oculta: 24 neurônios, ativação ReLU.
        model.add(layers.Dense(24, activation=activations.relu))
        
        # Camada de saída: o número de neurônios é igual ao número de ações possíveis.
        model.add(layers.Dense(self.action_size, activation='linear'))
        
        # Compila o modelo. A função de perda é o erro quadrático médio (MSE), pois estamos regredindo os valores Q.
        model.compile(loss=losses.mean_squared_error, optimizer=optimizers.legacy.Adam(learning_rate=self.learning_rate))
        
        # Exibe um sumário da arquitetura do modelo no console.
        model.summary()
    ...
    def act(self, state):
        ...
        # Exploitation: usa o modelo para prever os valores Q para o estado atual.
